...
?>
<input type="hidden" name="id_empresa" value="<?php echo $Partners_item['id'] ?>" />
<div class="form-group">
    <label for="nombre_empresa" class="col-sm-2 control-label">Título</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" name="nombre_empresa" placeholder="Empresa" value='<?php echo $Partners_item['nombre_empresa'] ?>'>
    </div>
</div>
<div class="form-group">
    <label for="url_empresa" class="col-sm-2 control-label">Url</label>
    <div class="col-sm-10">
        <input type="text" class="form-control" name="url_empresa" placeholder="URL empresa" value='<?php echo $Partners_item['url_empresa'] ?>'>
    </div>
</div>
<div class="form-group">
